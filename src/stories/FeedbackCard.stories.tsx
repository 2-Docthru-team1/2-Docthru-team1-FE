...
const mockComments = [
  { id: '1', content: 'This is a comment.', createdAt: new Date().toISOString(), ownerId: '123', owner: { name: 'John Doe' } },
  {
    id: '2',
...
export default { title: 'Components/FeedbackCard', component: FeedbackCard, argTypes: {} };
