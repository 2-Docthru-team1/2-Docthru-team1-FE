...
export default function ChallengeHeader() {
  return (
    <div className="flex flex-col items-center mt-[3.6rem] lg:w-[87.1rem] lg:px-0 md:w-full md:pl-[8rem] sm:w-full sm:min-w-[34.3rem] sm:pl-[5rem] ">
      <div className="flex w-full h-[4rem] justify-between items-center gap-0 pr-0 sm:gap-[1rem]">
        <p className="font-semibold text-[2rem] sm:text-[1.6rem] leading-[2.387rem] text-gray-700 whitespace-nowrap">
          Write your challenge
        </p>
        <div className="flex gap-[0.8rem] sm:gap-[0.3rem]">
