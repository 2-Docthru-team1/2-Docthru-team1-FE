...
export default function ToastComponent({ onClose, duration = 10000, onYesClick }: ToastProps) {
  useEffect(() => {
  ...
  return (
    <div className="flex justify-between lg:w-[89rem] md:w-[69.6rem] md:h-[4.8rem] sm:w-[34.3rem] sm:w-[5rem] p-[0.8rem] border border-gray-200 bg-primary-white rounded-[0.8rem]">
      ...
      <button
        className="w-[9rem] h-[3.2rem] rounded-[0.8rem] py-[0.2rem] px-[1.6rem] gap-[0.4rem] bg-primary-blue font-semibold text-[1.4rem] leading-[1.671rem] text-primary-white"
        onClick={onYesClick}
      >
        Yes
      </button>
