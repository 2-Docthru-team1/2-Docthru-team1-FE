...
export default function ChallengeTryClient() {
  ...
  return (
    <div
      className={`flex justify-center w-full md:h-[100vh] lg:flex-row lg:items-start md:flex-row md:items-start ${!isCardClicked ? 'sm:flex-row sm:items-start' : 'sm:flex-col sm:items-center'}`}
    >
      <div
        className={`flex-1 flex-col md:h-[100vh] items-center justify-start flex md:mr-0 sm:mr-0 lg:px-0 md:pl-[1.5rem] md:pr-[0] sm:px-[3.4rem] lg:w-[120rem] sm:w-full lg:order-1 md:order-1
